import { resolveComponent, openBlock, createElementBlock, createVNode, withCtx, createElementVNode, Fragment, renderList, createBlock, resolveDynamicComponent, mergeProps, toHandlers, createTextVNode, toDisplayString, withDirectives, vShow } from "vue";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_section_card = resolveComponent("section-card");
  return openBlock(), createElementBlock("div", null, [
      ...
      default: withCtx(() => [
        createElementVNode("div", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($props.actions, (action, index) => {
            return openBlock(), createBlock(resolveDynamicComponent(action.component), mergeProps(action, { parent: _ctx.$parent }, toHandlers(action.events), { key: index }), {
              default: withCtx(() => [
    ...
    withDirectives(createVNode(_component_section_card, { title: "Loading..." }, null, 512), [
      [vShow, $props.loading]
    ]),
    withDirectives(createElementVNode("div", null, [
      createVNode(_component_portal, { to: "sidebar-left" }, {
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.sections.sidebarLeft, (field, index) => {
            return openBlock(), createElementBlock("div", { key: index }, [
              field.is_panel ? (openBlock(), createBlock(resolveDynamicComponent(field.component), mergeProps({ key: 0 }, field, { form: $props.form }), {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(field.text), 1)
                ], void 0, true),
                _: 2
              }, 1040, ["form"])) : (openBlock(), createBlock(resolveDynamicComponent(field.component), mergeProps({ key: 1 }, field, {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($options.sections.body, (field, index) => {
        return openBlock(), createElementBlock("div", { key: index }, [
          field.is_panel ? (openBlock(), createBlock(resolveDynamicComponent(field.component), mergeProps({ key: 0 }, field, { form: $props.form }), {
            default: withCtx(() => [
              createTextVNode(toDisplayString(field.text), 1)
      ...
      createVNode(_component_portal, { to: "sidebar-right" }, {
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.sections.sidebarRight, (field, index) => {
            return openBlock(), createElementBlock("div", { key: index }, [
              field.is_panel ? (openBlock(), createBlock(resolveDynamicComponent(field.component), mergeProps({ key: 0 }, field, { form: $props.form }), {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(field.text), 1)
...
const SharedForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  SharedForm as S
};
