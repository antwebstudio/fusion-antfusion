...
import { resolveComponent, openBlock, createElementBlock, createVNode, mergeProps, withCtx, Fragment, renderList, createBlock, resolveDynamicComponent, createTextVNode, toDisplayString, createCommentVNode } from "vue";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_date_range_picker = resolveComponent("date-range-picker");
  const _component_ui_table = resolveComponent("ui-table");
  return openBlock(), createElementBlock("div", null, [
    createVNode(_component_date_range_picker, {
      opens: "right",
      showDropdowns: true,
      autoApply: true,
    ...
    createVNode(_component_ui_table, mergeProps(_ctx.$props, { endpoint: $options.reportEndpoint }), {
      actions: withCtx((table) => [
        table.record.actions ? (openBlock(), createElementBlock("div", _hoisted_1, [
...
const ReportDataTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  ReportDataTable as default
};
