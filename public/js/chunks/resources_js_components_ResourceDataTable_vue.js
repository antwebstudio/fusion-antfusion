...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    confirmBulkAction: function confirmBulkAction(dataTable) {
      var action = dataTable.allowedBulkActions[this.action];
      var vm = this;
      var formData = this.form.formdata();
      dataTable.selected.forEach(function (selected) {
    ...
    initForm: function initForm(dataTable) {
      var action = dataTable.allowedBulkActions[this.action];
                    ...
                    _c("div", { staticClass: "ml-auto" }, [
                      _c(
                        "select",
                        {
                          ...
                          attrs: { name: "bulk-actions", id: "bulk-actions" },
                          on: {
                            change: [
                              function ($event) {
                          ...
                          ? _c(
                              "ui-modal",
                              {
                                attrs: {
                                  ...
                                  title:
                                    "Confirm Bulk " +
                                    parent.allowedBulkActions[_vm.action].name,
                                },
                                scopedSlots: _vm._u(
                                  [
                                    {
                              ...
                              [
                                ...
                                parent.allowedBulkActions[_vm.action].params
                                  ...
                                  : _c("p", [
                                      ...
                                      _c("b", [
                                        _vm._v(_vm._s(parent.selected.length)),
                                      ]),
                                      _vm._v(
                                        " record" +
                                          _vm._s(
                                            parent.selected.length > 1
                                              ? "s"
                                              : ""
                                          ) +
                                          "?"
