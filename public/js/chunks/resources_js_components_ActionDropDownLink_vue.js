...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mixins: [_mixins_action_response__WEBPACK_IMPORTED_MODULE_0__["default"]],
  props: {
    cssClass: {},
    url: {},
    confirmButtonText: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    processActionError: function processActionError(error) {
      if (error.response && error.response.data && error.response.data.message) {
        toast(error.response.data.message, 'error');
      }
    },
    processBlobResponse: function processBlobResponse(response) {
      var _this = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var contentType, text, json, contentDisposition, headerFilename, filename, url, blob, blobUrl;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return new Response(response.data).text();

              case 6:
                text = _context.sent;
                json = JSON.parse(text);

                _this.processActionResponseData(json);
              ...
              case 10:
                ...
                _this.downloadBlob(blobUrl, filename); // window.open(blobUrl);
    ...
    downloadBlob: function downloadBlob(blobUrl, filename) {
    ...
    processActionResponseData: function processActionResponseData(data) {
      if (data.message) {
