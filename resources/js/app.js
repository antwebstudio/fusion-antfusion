...
window.Fusion.booting(function (Vue, router, store) {
    ...
    Vue.component('antfusion-primevue-datatable', () => import('./components/PrimeVueDataTable'))
    ...
    Vue.component('action-text', () => import('./components/ActionText'))
    ...
    Vue.component('resource-primevue-datatable', () => import('./components/ResourcePrimeVueDataTable'))
